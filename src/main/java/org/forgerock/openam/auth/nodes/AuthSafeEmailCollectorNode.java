...
@Node.Metadata(outcomeProvider = SingleOutcomeNode.OutcomeProvider.class,
        configClass = AuthSafeEmailCollectorNode.Config.class)
public class AuthSafeEmailCollectorNode extends SingleOutcomeNode {
    private final Logger logger = LoggerFactory.getLogger(AuthSafeEmailCollectorNode.class);
     ...
     */
    @Inject
    public AuthSafeEmailCollectorNode(@Assisted Config config,
    ...
    private boolean checkRequiredAttributes(List<AttributeInputCallback> receivedCallbacks,
        ...
        if (config.required()) {
            boolean receivedCallbacksNonNull = receivedCallbacks.stream().noneMatch(callback -> {
                ...
                if (((Set<String>) callback).isEmpty()) {
