...
//		String data = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.127 Safari/537.36 Edg/100.0.1185.50";
//		Parser uaParser = new Parser();
//		Client c = uaParser.parse(data);
//			String browser = c.userAgent.family.toString();
//			String operatingSystem = c.os.family.toString();
//			System.out.println(browser+operatingSystem+c.os.major);
	}
//		  	
//		 
